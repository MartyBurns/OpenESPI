...
@RequestMapping("/electricpowerqualitysummarys")
@Controller
@RooWebScaffold(path = "electricpowerqualitysummarys", formBackingObject = ElectricPowerQualitySummary.class)
public class ElectricPowerQualitySummaryController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        ElectricPowerQualitySummary resource = ElectricPowerQualitySummary.findElectricPowerQualitySummary(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.ElectricPowerQualitySummary.class);
