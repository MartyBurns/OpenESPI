...
public class ThirdPartyApplicationUseAdapter extends XmlAdapter<String, ThirdPartyApplicationUse> {
   
	@Override
	public ThirdPartyApplicationUse unmarshal(String v)
			throws Exception {
		int value = Integer.valueOf(v);
		ThirdPartyApplicationUse aKind = null;
		List <ThirdPartyApplicationUse> kinds = ThirdPartyApplicationUse.findAllThirdPartyApplicationUses();
	...
	@Override
	public String marshal(ThirdPartyApplicationUse v)
			throws Exception {
