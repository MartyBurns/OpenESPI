...
@Controller
@RooWebScaffold(path = "meterreadings", formBackingObject = MeterReading.class)
public class MeterReadingController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        MeterReading resource = MeterReading.findMeterReading(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.MeterReading.class);
