...
@RequestMapping("/readingtypes")
@Controller
@RooWebScaffold(path = "readingtypes", formBackingObject = ReadingType.class)
public class ReadingTypeController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        ReadingType resource = ReadingType.findReadingType(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.ReadingType.class);
