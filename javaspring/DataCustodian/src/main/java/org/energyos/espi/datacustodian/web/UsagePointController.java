...
@Controller
@RooWebScaffold(path = "usagepoints", formBackingObject = UsagePoint.class)
public class UsagePointController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        UsagePoint resource = UsagePoint.findUsagePoint(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.UsagePoint.class);
