...
privileged aspect IntervalBlock_Roo_JavaBean {
    ...
    public DateTimeInterval IntervalBlock.getEspiinterval() {
        return this.espiinterval;
    }
    
    public void IntervalBlock.setEspiinterval(DateTimeInterval espiinterval) {
        this.espiinterval = espiinterval;
    }
