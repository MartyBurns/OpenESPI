...
@Controller
@RooWebScaffold(path = "retailcustomers", formBackingObject = RetailCustomer.class)
public class RetailCustomerController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        RetailCustomer resource = RetailCustomer.findRetailCustomer(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.domain.RetailCustomer.class);
