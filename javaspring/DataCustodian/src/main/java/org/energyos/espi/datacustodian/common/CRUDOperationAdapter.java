...
public class CRUDOperationAdapter extends XmlAdapter<String, CRUDOperation> {
   
	@Override
	public CRUDOperation unmarshal(String v)
			throws Exception {
		int value = Integer.valueOf(v);
		CRUDOperation aKind = null;
		List <CRUDOperation> kinds = CRUDOperation.findAllCRUDOperations();
		Iterator<CRUDOperation> iterator = kinds.iterator();
