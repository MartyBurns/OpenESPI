...
public class KindAdapter extends XmlAdapter<String, Kind> {
   
	@Override
	public Kind unmarshal(String v)
			throws Exception {
		int value = Integer.valueOf(v);
		Kind aKind = null;
		List <Kind> kinds = Kind.findAllKinds();
		Iterator<Kind> iterator = kinds.iterator();
