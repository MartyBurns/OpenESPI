...
@RequestMapping("/applicationinformations")
@Controller
@RooWebScaffold(path = "applicationinformations", formBackingObject = ApplicationInformation.class)
public class ApplicationInformationController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        ApplicationInformation resource = ApplicationInformation.findApplicationInformation(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.ApplicationInformation.class);
