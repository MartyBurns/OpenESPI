...
public interface DataCustodian {
	...
	public List <Authorization> _ReadAuthorizationList(String customerID);
        // ToDo: Encapulation of Retail Customer - for now it's a String. It should be of type RetailCustomerId
        //       to implement, look-up the string in the collection of ~.domain.RetailCustomer
	 ...
	 */
	public ApplicationInformation ReadData_(Authorization authorization, DateTimeInterval requestedInterval);
        // ToDo: Verify the change in return value from "DataResource" to ApplicationInformation is correct
