...
@RequestMapping("/electricpowerusagesummarys")
@Controller
@RooWebScaffold(path = "electricpowerusagesummarys", formBackingObject = ElectricPowerUsageSummary.class)
public class ElectricPowerUsageSummaryController {
    ...
    public String getResource(@PathVariable("id") Long id)  {
        ...
        String xmlResult;
        // get the resource                                                                                                                                                                                                                                                
        ElectricPowerUsageSummary resource = ElectricPowerUsageSummary.findElectricPowerUsageSummary(id);
        ...
        if (resource == null) {
            ...
            try {
                context = JAXBContext.newInstance(org.energyos.espi.datacustodian.common.ElectricPowerUsageSummary.class);
