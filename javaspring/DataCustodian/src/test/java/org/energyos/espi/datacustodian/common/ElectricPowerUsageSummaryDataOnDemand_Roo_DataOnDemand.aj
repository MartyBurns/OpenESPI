...
privileged aspect ElectricPowerUsageSummaryDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    DateTimeIntervalDataOnDemand ElectricPowerUsageSummaryDataOnDemand.dateTimeIntervalDataOnDemand;
    
    @Autowired
    CurrencyDataOnDemand ElectricPowerUsageSummaryDataOnDemand.currencyDataOnDemand;
    
    @Autowired
    SummaryMeasurementDataOnDemand ElectricPowerUsageSummaryDataOnDemand.summaryMeasurementDataOnDemand;
    
    @Autowired
    QualityOfReadingDataOnDemand ElectricPowerUsageSummaryDataOnDemand.qualityOfReadingDataOnDemand;
