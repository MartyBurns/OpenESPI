...
privileged aspect MeterReadingIntegrationTest_Roo_IntegrationTest {
    ...
    public void MeterReadingIntegrationTest.testCountMeterReadings() {
        ...
        long count = org.energyos.espi.datacustodian.domain.MeterReading.countMeterReadings();
    ...
    public void MeterReadingIntegrationTest.testFindMeterReading() {
        org.energyos.espi.datacustodian.domain.MeterReading obj = dod.getRandomMeterReading();
        ...
        obj = org.energyos.espi.datacustodian.domain.MeterReading.findMeterReading(id);
    ...
    public void MeterReadingIntegrationTest.testFindAllMeterReadings() {
        ...
        java.util.List<org.energyos.espi.datacustodian.domain.MeterReading> result = org.energyos.espi.datacustodian.domain.MeterReading.findAllMeterReadings();
    ...
    public void MeterReadingIntegrationTest.testFindMeterReadingEntries() {
        ...
        java.util.List<org.energyos.espi.datacustodian.domain.MeterReading> result = org.energyos.espi.datacustodian.domain.MeterReading.findMeterReadingEntries(0, (int) count);
    ...
    public void MeterReadingIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyMeterReading(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.energyos.espi.datacustodian.domain.MeterReading merged =  obj.merge();
        obj.flush();
    ...
    public void MeterReadingIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'MeterReading' failed to initialize correctly", dod.getRandomMeterReading());
        org.energyos.espi.datacustodian.domain.MeterReading obj = dod.getNewTransientMeterReading(Integer.MAX_VALUE);
    ...
    public void MeterReadingIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'MeterReading' with identifier '" + id + "'", org.energyos.espi.datacustodian.domain.MeterReading.findMeterReading(id));
    }
