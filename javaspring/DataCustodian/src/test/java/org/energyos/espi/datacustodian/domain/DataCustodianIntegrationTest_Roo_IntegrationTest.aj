...
privileged aspect DataCustodianIntegrationTest_Roo_IntegrationTest {
    ...
    public void DataCustodianIntegrationTest.testCountDataCustodians() {
        ...
        long count = org.energyos.espi.datacustodian.domain.DataCustodian.countDataCustodians();
    ...
    public void DataCustodianIntegrationTest.testFindDataCustodian() {
        org.energyos.espi.datacustodian.domain.DataCustodian obj = dod.getRandomDataCustodian();
        ...
        obj = org.energyos.espi.datacustodian.domain.DataCustodian.findDataCustodian(id);
    ...
    public void DataCustodianIntegrationTest.testFindAllDataCustodians() {
        ...
        java.util.List<org.energyos.espi.datacustodian.domain.DataCustodian> result = org.energyos.espi.datacustodian.domain.DataCustodian.findAllDataCustodians();
    ...
    public void DataCustodianIntegrationTest.testFindDataCustodianEntries() {
        ...
        java.util.List<org.energyos.espi.datacustodian.domain.DataCustodian> result = org.energyos.espi.datacustodian.domain.DataCustodian.findDataCustodianEntries(0, (int) count);
    ...
    public void DataCustodianIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyDataCustodian(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.energyos.espi.datacustodian.domain.DataCustodian merged =  obj.merge();
        obj.flush();
    ...
    public void DataCustodianIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'DataCustodian' failed to initialize correctly", dod.getRandomDataCustodian());
        org.energyos.espi.datacustodian.domain.DataCustodian obj = dod.getNewTransientDataCustodian(Integer.MAX_VALUE);
    ...
    public void DataCustodianIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'DataCustodian' with identifier '" + id + "'", org.energyos.espi.datacustodian.domain.DataCustodian.findDataCustodian(id));
    }
