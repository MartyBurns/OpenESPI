...
privileged aspect _RetailCustomer_Roo_JavaBean {
    
    public String _RetailCustomer.getRetailCustomerID() {
        return this.retailCustomerID;
    }
    
    public void _RetailCustomer.setRetailCustomerID(String retailCustomerID) {
