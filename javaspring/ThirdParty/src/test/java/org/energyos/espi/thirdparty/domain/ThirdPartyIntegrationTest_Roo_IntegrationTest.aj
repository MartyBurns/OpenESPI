...
privileged aspect ThirdPartyIntegrationTest_Roo_IntegrationTest {
    ...
    public void ThirdPartyIntegrationTest.testCountThirdPartys() {
        ...
        long count = org.energyos.espi.thirdparty.domain.ThirdParty.countThirdPartys();
    ...
    public void ThirdPartyIntegrationTest.testFindThirdParty() {
        org.energyos.espi.thirdparty.domain.ThirdParty obj = dod.getRandomThirdParty();
        ...
        obj = org.energyos.espi.thirdparty.domain.ThirdParty.findThirdParty(id);
    ...
    public void ThirdPartyIntegrationTest.testFindAllThirdPartys() {
        ...
        java.util.List<org.energyos.espi.thirdparty.domain.ThirdParty> result = org.energyos.espi.thirdparty.domain.ThirdParty.findAllThirdPartys();
    ...
    public void ThirdPartyIntegrationTest.testFindThirdPartyEntries() {
        ...
        java.util.List<org.energyos.espi.thirdparty.domain.ThirdParty> result = org.energyos.espi.thirdparty.domain.ThirdParty.findThirdPartyEntries(0, (int) count);
    ...
    public void ThirdPartyIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyThirdParty(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.energyos.espi.thirdparty.domain.ThirdParty merged =  obj.merge();
        obj.flush();
    ...
    public void ThirdPartyIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'ThirdParty' failed to initialize correctly", dod.getRandomThirdParty());
        org.energyos.espi.thirdparty.domain.ThirdParty obj = dod.getNewTransientThirdParty(Integer.MAX_VALUE);
    ...
    public void ThirdPartyIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'ThirdParty' with identifier '" + id + "'", org.energyos.espi.thirdparty.domain.ThirdParty.findThirdParty(id));
    }
